...
nextAction = ""
nextMetaAction = ""
numberOfRuns = 5  # Specify how many runs we are doing.
totalInputToken = 0
totalOutputToken = 0

def read_action_meta_action_list(file_path):
...
if __name__ == "__main__":
    ...
    jsonlFilePath = r'E:\projects\Research\batchRequests.jsonl'  # New JSONL file for batch requests
    actionMetaActionFile = r'E:\projects\Research\Action-Meta-action-list.pdf'  # PDF file path
    ...
    # Read the Action-Meta-action-list file
    action_meta_action_list = read_action_meta_action_list(actionMetaActionFile)
            ...
            jsonl_data = {
                ...
                "body": {
                    ...
                    "messages": [
                        ...
                        The user will give you data about a person's body parts and positioning, this data is given from a 3d perspective 
                        where you receive each body part's position in an x,y,z format and their rotations in an x,y,z format.
                        You also get each body part's position in a 2d perspective from multiple camera angles in an x,y format and you get a confidence level. 
                        I then need you to tell the user what the person observed is doing and predict what they are about to do. 
                        You are to match each action to a specific meta-action and action found in the list below:
                        Take your time, there is absolutely no rush. I want the answer to be correct, not quick.
                        """},
                        {"role": "user", "content": """
                        ...
                        """},
                        {"role": "user", "content": """
                        The format should be exactly as follows. Don't include (New line) but do have a line in between meta-action and Action
                        ...
                        {"role": "user", "content": """
                        Do not output any information about the following threads. The reader doesn't need to know about the Microsoft Excel file.
                        """},
                        {"role": "user", "content":"""
                        ...
                        """},
                        {"role": "user", "content": """
                        {action_meta_action_list}
                        """},
                        {"role": "user", "content": """
                        Do not tell the reader about the source of the actions and meta-actions. You also do not have to include the number in the leftmost column. 
                        For example, if you pick 'taking components', it should be 'taking components', not 'taking components9'.
                        The action also shouldn't include any numbers. Also don't reference your sources.
                        """},
                        {"role": "user", "content": """
